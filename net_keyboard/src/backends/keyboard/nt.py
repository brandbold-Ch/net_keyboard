...
class NtEventListener(KeyboardBackend):
    """
    ...
    def listen(self) -> None:
        ...
        launcher = IPCProcessLauncher(
            server="posix/klevent" if self.os_name == "posix" else "nt/kwevent",
            client=KeyListener(on_press=self.on_press, on_release=self.on_release),
